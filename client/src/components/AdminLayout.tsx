...
import {
  ...
  CalendarOff,
  MessageSquare,
  // Added so each destination has its own recognizable glyph (UX-3):
  LayoutDashboard,
  MapPin,
  Contact,
  Siren,
...
// Groups are organized by user goal so an item's location is predictable. The
// former 11-item "Tools" junk drawer is split into People & Payroll, AI &
// Knowledge, and Admin; payroll/time moved out of "Field Work"; the 2-item
// "Reports" group folded into "Inspections & Reports". (UX-1)
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Devices",          href: "/admin/devices",            icon: Siren      },
      { label: "Asset Lifecycle",  href: "/admin/asset-lifecycle",    icon: History    },
    ],
  },
  {
    id: "inspections",
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Purchase Orders",   href: "/admin/purchase-orders",   icon: FileSpreadsheet },
    ],
  },
  {
    id: "inventory",
    ...
    items: [
      ...
      { label: "Parts Catalog",  href: "/admin/parts-catalog",  icon: Boxes        },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Equipment Knowledge", href: "/admin/equipment-knowledge", icon: Cog        },
      { label: "Knowledge Review",    href: "/admin/knowledge-review",    icon: FileSearch },
    ],
  },
  {
    id: "admin",
    ...
    items: [
      ...
      { label: "Setup Wizard",   href: "/admin/setup",          icon: Wand2         },
