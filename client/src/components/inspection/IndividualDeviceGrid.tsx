          ...
          <tbody>
                  ...
                  {!isFinalized && (
                    <td className="px-1 py-1 text-center">
                      {confirmDeleteId === device.id ? (
                        ...
                        <button onClick={() => setConfirmDeleteId(device.id)} className="text-muted-foreground/40 hover:text-red-500 transition-colors p-0.5" title="Remove device">
            ...
            {!isFinalized && showAddRow && (
              <tr className="border-b bg-blue-50/40 dark:bg-blue-950/10">
                <td className="px-2 py-1.5 text-center text-muted-foreground border-r font-mono">{devices.length + 1}</td>
                ...
                <td colSpan={9} className="px-2 py-1 text-muted-foreground/40 text-[10px] border-r">Fill remaining fields after saving</td>
            ...
            {devices.length === 0 && !showAddRow && (
              <tr>
                <td colSpan={14} className="text-center py-8 text-muted-foreground">No devices in this category</td>
              </tr>
            )}
          </tbody>
        </table>
