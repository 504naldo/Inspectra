...
export const sprinklerRouter = router({
  ...
  upsertSystems: technicianProcedure.input(z.object({
    ...
    systems: z.array(z.object({
      ...
      systemWaterPressure: z.string().optional(),
      supplyWaterPressure: z.string().optional(),
      residualPressure: z.string().optional(),
      systemAirPressure: z.string().optional(),
      lowAirSwitchCutIn: z.string().optional(),
      tripPressure: z.string().optional(),
    })),
  })).mutation(async ({ input }) => {
