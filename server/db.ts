...
// ── Extracted modules (incremental maintainability refactor — no behavior change) ──
// The Drizzle client moved to ./db/client; job & job-assignment data access moved
// to ./db/jobs. Both are re-exported here so every existing
...
// ============================================
// JOB QUERIES + JOB ASSIGNMENT QUERIES
// Moved to ./db/jobs.ts (re-exported at the top of this file). New code may
// import them from "../db" (unchanged) or directly from "../db/jobs".
// ============================================
